...
window.onload = function () {
  var sl = new window.ShaderLoader();
  sl.loadShaders(
    {
      birdFS: "",
      birdVS: "",
...
function initComputeRenderer() {
  ...
  velocityVariable = gpuCompute.addVariable(
    ...
    ShaderLoader.get("fragmentShaderVelocity"),
    dtVelocity
  );
  positionVariable = gpuCompute.addVariable(
    "texturePosition",
    // document.getElementById("fragmentShaderVelocity").textContent,
    ShaderLoader.get("fragmentShaderPosition"),
    dtPosition
  );
...
function initBirds() {
  ...
  const material = new THREE.ShaderMaterial({
    ...
    vertexShader: window.ShaderLoader.get("birdVS"),
    // fragmentShader: document.getElementById("birdFS").textContent,
    fragmentShader: window.ShaderLoader.get("birdFS"),
